...
public class MissedRecyclerViewAdapter extends RecyclerView.Adapter<MissedRecyclerViewAdapter.ViewHolder> {
    ...
    public MissedRecyclerViewAdapter(Context context, Cursor c) {
        mContext = context;
