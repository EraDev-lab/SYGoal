...
public class TaskGoalContract implements BaseColumns {
    public static final String TABLE_NAME = "Task";

    public static final String Task_Id = BaseColumns._ID;
    public static final String Task_Name = "task_name";
    public static final String Task_Goal_Name = "task_goal_name";
    ...
    public TaskGoalContract() {
    }

    public TaskGoalContract(int taskId, int goalId, String name, String goalName, String date, String notifyOn, String alarm, String checkboxCompleted) {
        this.taskId = taskId;
        this.goalId = goalId;
        this.name = name;
    ...
    public TaskGoalContract(int taskId, int goalId, String checkboxCompleted) {
        this.taskId = taskId;
        this.goalId = goalId;
        this.checkboxCompleted = checkboxCompleted;
    }

    public TaskGoalContract(String name, String goalName, String date, String notifyOn, String alarm, String checkboxCompleted) {
        this.name = name;
        this.goalName = goalName;
        this.date = date;
        this.notifyOn = notifyOn;
    ...
    public void setTaskGoalName(String goalName) {
        this.goalName = goalName;
    }
