...
public class HelperClass extends SQLiteOpenHelper {
    ...
    public GoalContract getGoal(long id) {
        ...
        GoalContract contract = new GoalContract(
                cursor.getInt(cursor.getColumnIndex(GoalContract._ID)),
                cursor.getString(cursor.getColumnIndex(GoalContract.Goal_Name)),
                cursor.getString(cursor.getColumnIndex(GoalContract.Goal_Type)),
                cursor.getString(cursor.getColumnIndex(GoalContract.Goal_Description)));
    ...
    //________________________________________________________________________________
    public List<GoalContract> getAllGoal() {
        List<GoalContract> employees = new ArrayList<>();

        // Select All Query
        String selectQuery = "SELECT  * FROM " + GoalContract.TABLE_NAME + " ORDER BY " +
                GoalContract.Goal_Type + " ASC";
        ...
        if (cursor.moveToFirst()) {
            do {
                GoalContract contract = new GoalContract();
                contract.setGoalId(cursor.getInt(cursor.getColumnIndex(GoalContract._ID)));
                contract.setGoalName(cursor.getString(cursor.getColumnIndex(GoalContract.Goal_Name)));
                contract.setGoalType(cursor.getString(cursor.getColumnIndex(GoalContract.Goal_Type)));
                contract.setGoalDescription(cursor.getString(cursor.getColumnIndex(GoalContract.Goal_Description)));
    ...
    public int getGoalCount() {
        String countQuery = "SELECT  * FROM " + GoalContract.TABLE_NAME;
        //open the database
        SQLiteDatabase db = this.getReadableDatabase();
    ...
    //________________________________________________________________________________
    public TaskContract getTask(long id) {
        // get readable database as we are not inserting anything
        SQLiteDatabase db = this.getReadableDatabase();
        ...
        TaskContract contract = new TaskContract(
                cursor.getInt(cursor.getColumnIndex(TaskContract.Task_Id)),
                cursor.getInt(cursor.getColumnIndex(TaskContract.Task_Goal_Id)),
                cursor.getString(cursor.getColumnIndex(TaskContract.Task_Name)),
                cursor.getString(cursor.getColumnIndex(TaskContract.Task_Date)),
                cursor.getString(cursor.getColumnIndex(TaskContract.Task_Notify_On)),
                cursor.getString(cursor.getColumnIndex(TaskContract.Task_Alarm)),
                cursor.getString(cursor.getColumnIndex(TaskContract.Task_CheckBox_Completed)));
    ...
    //________________________________________________________________________________
    public List<TaskContract> getAllTask() {
        List<TaskContract> employees = new ArrayList<>();

        // Select All Query
        String selectQuery = "SELECT  * FROM " + TaskContract.TABLE_NAME + " ORDER BY " +
                TaskContract.Task_Date + " ASC";
        ...
        if (cursor.moveToFirst()) {
            do {
                TaskContract contract = new TaskContract();
                contract.setTaskId(cursor.getInt(cursor.getColumnIndex(TaskContract.Task_Id)));
                contract.setTaskGoalId(cursor.getInt(cursor.getColumnIndex(TaskContract.Task_Goal_Id)));
                contract.setTaskName(cursor.getString(cursor.getColumnIndex(TaskContract.Task_Name)));
                contract.setTaskDate(cursor.getString(cursor.getColumnIndex(TaskContract.Task_Date)));
                contract.setTaskNotifyOn(cursor.getString(cursor.getColumnIndex(TaskContract.Task_Notify_On)));
                contract.setTaskAlarm(cursor.getString(cursor.getColumnIndex(TaskContract.Task_Alarm)));
                contract.setTaskCheckBoxCompleted(cursor.getString(cursor.getColumnIndex(TaskContract.Task_CheckBox_Completed)));
    ...
    public int getTaskCount() {
        String countQuery = "SELECT  * FROM " + TaskContract.TABLE_NAME;
        //open the database
        SQLiteDatabase db = this.getReadableDatabase();
